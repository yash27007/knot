...
export const PrismaClientRustPanicError =
...
type EitherStrict<O extends object, K extends Key> = Strict<
  __Either<O, K>
>;
...
export type Extends<A1 extends any, A2 extends any> = [A1] extends [
  never,
]
...
export type Keys<U extends Union> = U extends unknown
  ? keyof U
  : never;
...
export type MaybeTupleToUnion<T> = T extends any[]
  ? TupleToUnion<T>
  : T;
...
export type FieldRef<Model, FieldType> = runtime.FieldRef<
  Model,
  FieldType
>;
    ...
    Connection: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.ConnectionCountAggregateOutputType>
            | number;
        };
      };
    };
 ...
 * Reference to a field of type 'DateTime[]'
 */
export type ListDateTimeFieldRefInput<$PrismaModel> =
  FieldRefInputType<$PrismaModel, "DateTime[]">;

/**
 * Reference to a field of type 'NodeType'
 */
export type EnumNodeTypeFieldRefInput<$PrismaModel> =
  FieldRefInputType<$PrismaModel, "NodeType">;

/**
 * Reference to a field of type 'NodeType[]'
 */
export type ListEnumNodeTypeFieldRefInput<$PrismaModel> =
  FieldRefInputType<$PrismaModel, "NodeType[]">;
 ...
 */
export type EnumQueryModeFieldRefInput<$PrismaModel> =
  FieldRefInputType<$PrismaModel, "QueryMode">;
